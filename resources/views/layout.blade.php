...
<body>
    ...
    <div class="sidebar animate__animated animate__fadeInLeft">
        ...
        <a href="{{ url('/batches') }}"><i class="bi bi-calendar3"></i> Classes</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm rounded animate__animated animate__fadeInDown mt-3 mb-4 px-3">
                    <div class="container-fluid">
                        <a class="navbar-brand d-flex align-items-center" href="#">
                            <i class="bi bi-mortarboard-fill me-2 fs-3 text-primary"></i>
                            <span class="fw-bold" style="letter-spacing:1px;">Student Management System</span>
                        </a>

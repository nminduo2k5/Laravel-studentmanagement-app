    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        @if(isset($enrollment->midterm_grade) || isset($enrollment->final_grade) || isset($enrollment->assignment_grade))
          <div class="row">
            <div class="col-md-4">
              <div class="card border-primary mb-3">
                <div class="card-header bg-primary text-white text-center">Điểm giữa kỳ (30%)</div>
            ...
            <div class="col-md-4">
              <div class="card border-danger mb-3">
                <div class="card-header bg-danger text-white text-center">Điểm cuối kỳ (50%)</div>
                <div class="card-body text-center">
            ...
            <div class="col-md-4">
              <div class="card border-success mb-3">
                <div class="card-header bg-success text-white text-center">Điểm bài tập (20%)</div>
                <div class="card-body text-center">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                          <h5 class="mb-1">Điểm tổng kết</h5>
            ...
            <div class="col-md-4">
              <div class="card border-secondary h-100">
                ...
                <div class="card-body d-flex flex-column justify-content-between">
                  <div>
                    <p class="text-muted">Cập nhật điểm số và nhận xét cho sinh viên</p>
                  </div>
                  <div class="mt-3">
          ...
          <div class="card mt-4">
            <div class="card-header bg-secondary text-white">
              <h5 class="mb-0"><i class="bi bi-chat-quote me-2"></i>Nhận xét của giáo viên</h5>
            </div>
            <div class="card-body">
        ...
        @else
          <div class="alert alert-info">
            <div class="d-flex justify-content-between align-items-center">
              <span><i class="bi bi-info-circle me-2"></i> Chưa có thông tin điểm số cho sinh viên này.</span>
